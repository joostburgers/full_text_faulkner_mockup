(function () {
	...
	var DY_TEXT = {
		code:             'SF',
		prefix:           'sf_',
		narrativePresent: 1928,  // the three 1928 sections; stored in Drupal upstream
		// Matches the .ft-section-num text emitted by build_text_data.py
		sectionRe:        /^(?:January|February|March|April|May|June|July|August|September|October|November|December)\s+\w+,\s*\d{4}\.?$/
	};
